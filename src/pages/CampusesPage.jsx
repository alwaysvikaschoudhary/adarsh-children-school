...
const campusPage = () => {
  ...
  return (
    <div>
      ...
      <section className="relative bg-gradient-to-br from-emerald-900 via-teal-800 to-green-900 text-white py-6 md:py-8 overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-10">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 30% 55%, white 1px, transparent 1px), radial-gradient(circle at 70% 45%, white 1px, transparent 1px)",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="text-center md:text-left animate-slide-in-left">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
                Our <span className="text-emerald-400">campus</span>
                <br />
                Two Locations
              </h1>

              <p className="text-lg md:text-xl text-emerald-100 mb-6 leading-relaxed">
                Two modern campus in Jaipur, Rajasthan, designed to provide the
                best learning environment for all age groups
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 mb-8 max-w-md mx-auto md:mx-0">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center hover:bg-white/20 transition-all">
                  ...
                  <div className="text-[10px] text-emerald-300">ACS</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center hover:bg-white/20 transition-all">
                  <FaMapMarkedAlt className="text-2xl mx-auto mb-1 text-emerald-400" />
                  <div className="text-xs text-emerald-200">Bhankrota</div>
                  <div className="text-[10px] text-emerald-300">Jaipur</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center hover:bg-white/20 transition-all">
              ...
              >
                <div
                  className={`bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center transition-all duration-700 delay-150 ${
                    heroStatsVisible
                ...
                <div
                  className={`bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center transition-all duration-700 delay-300 ${
                    heroStatsVisible
                      ? "opacity-100 scale-100"
                      : "opacity-0 scale-90"
                  }`}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Both campus are strategically located in Bhankrota and
                      Bhankrota areas of Jaipur, providing easy accessibility
                ...
                <div className="flex items-start space-x-4">
                  <div className="bg-green-100 text-green-600 w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 font-bold">
                    2
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-2">
                    ...
                    <p className="text-gray-600">
                      Main campus for older students with advanced facilities,
                      and Adarsh Children's Early Years specially designed for
                      early years education with safe, child-friendly spaces.
                    </p>
                  </div>
                </div>

                <div className="flex items-start space-x-4">
                  <div className="bg-purple-100 text-purple-600 w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 font-bold">
                    3
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-2">
                    ...
                    <p className="text-gray-600">
                      State-of-the-art classrooms, laboratories, libraries,
                      sports facilities, and technology-enabled learning
                      environments at both locations.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      24/7 security, CCTV surveillance, secure entry systems,
                      and trained security personnel ensure the safety of our
                ...
                <div className="flex items-start space-x-4">
                  <div className="bg-red-100 text-red-600 w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 font-bold">
                    5
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-2">
                    ...
                    <p className="text-gray-600">
                      Reliable bus service covering major routes in Jaipur with
                      GPS-enabled buses and trained drivers for safe commute.
                    </p>
                  </div>
                </div>
              </div>
