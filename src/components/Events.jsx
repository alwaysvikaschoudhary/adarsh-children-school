  ...
  const events = [
    {
      ...
      description:
        "A day filled with athletic competitions, team spirit, and celebration of sportsmanship.",
      image:
    ...
    },
    {
      ...
      description:
        "Students showcase innovative projects and scientific experiments from various fields.",
      image:
    ...
    },
    {
      ...
      location: "School Auditorium",
      description:
        "An evening of music, dance, drama, and cultural performances by our talented students.",
      image:
    ...
    },
    {
      ...
      location: "Both campus",
      description:
        "Interactive session to discuss student progress and strengthen school-parent partnership.",
      image:
      ...
      <div className="container mx-auto px-4">
          ...
          {events.map((event, index) => (
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden">
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-t ${event.color} opacity-50`}
                ></div>
        ...
        <div className="mt-16 text-center animate-fade-in-up">
          <p className="text-gray-600 mb-4">
            Want to stay informed about all our events?
          </p>
          <Link
            to="/contact"
