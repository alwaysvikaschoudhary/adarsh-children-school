  ...
  const testimonials = [
    {
      ...
      text: "Adarsh Children's Senior Secondary School has been instrumental in shaping my child's future. The teachers are dedicated, and the facilities are excellent. I highly recommend this school to all parents.",
      rating: 5,
    },
    {
      name: "Priya Mehta",
      ...
      text: "The holistic approach to education at acs is remarkable. My daughter has not only excelled academically but also developed confidence through various co-curricular activities.",
      rating: 5,
    },
    {
      name: "Amit Kumar",
      role: "Parent - Adarsh Children's Early Years",
      image:
        "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=200&auto=format&fit=crop",
      text: "Adarsh Children's Early Years provides a nurturing environment for young children. The play-based learning approach has helped my son develop essential skills while having fun.",
      rating: 5,
    },
    {
      name: "Sunita Patel",
      ...
      text: "The faculty at acs is highly qualified and caring. They go the extra mile to ensure every student reaches their full potential. Thank you for the wonderful education!",
      rating: 5,
    },
    {
      name: "Vikram Singh",
